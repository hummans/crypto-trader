...
const pusher = new GTT.utils.PushBullet('o.7WJjTJZm9Bedebq1rOopW9gsq3XG92Yg');
// const deviceID = process.env.PUSHBULLET_DEVICE_ID;
const deviceID = 'ujBo0CDM8misjAbG9SO9ts'; // Google Pixel
...
function submitTrade(side: string, amount: string) {
    console.log(`simulating ${side} with amount ${amount}`);
